...
mysql -u root  -p -e 'DROP DATABASE IF EXISTS `nemne_insurance`; CREATE DATABASE `nemne_insurance` CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;'
mysql -u root  -p -e 'source ./sql/initialization.sql;'
echo "OK"
exit